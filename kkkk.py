...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 Alauddin𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   Alauddin         \033[1;31m
...
def XYZ():
    ...
    print(f"{RED}[04] {WHITE}BANGALDESH RANDOM CLONE ")
    print(f"\043[1;91m====================================================")
    WASIM = input("[√] CHOOSE : ")
    if WASIM in ["1","01"]:
        passx()
...
def passx():
    ...
    print("")
    print(f"{RED}[01] {WHITE}AUTO PASS 6 DIGITS         {GREEN}[FASTEST]")
    print(f"{RED}[02] {WHITE}AUTO PASS 6 AND 11 DIGITS  {GREEN}[FAST]")
...
def pass1():
    ...
    print(f"")
        print(f' {GREEN}[!] Bd SIM CODES : {B}01714, 01321, 01840, 01645')
        print(f' {GREEN}[!]               : {V}0178, 0302, 0301, 0305')
    print(f' {GREEN}[!]               : {M}0349, 0316, 0314, 0335')
